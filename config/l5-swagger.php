...
return [
    ...
    'documentations' => [
        'v1' => [
            'api' => [
                ...
                'version' => '1.0.0',
                'description' => 'Lang Cards API version 1',
                'termsOfService' => '',
                'contact' => [
        ...
        'v2' => [
            'api' => [
                'title' => 'Lang Cards API V2',
                'version' => '2.0.0',
                'description' => 'Lang Cards API version 2',
                'termsOfService' => '',
                'contact' => [
                    'email' => 'vlad2000100600@gmail.com'
                ],
    ...
    'v1' => [
        ...
        */
         ...
         */
        'constants' => [
            //'L5_SWAGGER_CONST_HOST' =>  env('APP_URL', 'http://localhost')."/api/v1",
