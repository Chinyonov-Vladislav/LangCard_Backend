...
return [
    ...
    */
    ...
    'zero_count_on_page'=>env('ZERO_COUNT_ON_PAGE',0),

    'zero_page' => env('ZERO_PAGE', 0),

    'is_use_real_ip_address'=>env('IS_USE_REAL_IP_ADDRESS',false),
    'expiration_verification_email_code'=>(int)env('EXPIRATION_VERIFICATION_EMAIL_CODE',10),
    'expiration_two_factor_email_code' => env('EXPIRATION_TWO_FACTOR_EMAIL_CODE',10),
